...
- (void)sunposAtDay:(double)d longitude:(double *)lng r:(double *)r;
- (int)sunRiseSetHelperForYear:(int)year month:(int)month day:(int)day longitude:(double)lon latitude:(double)lat altitude:(double)altit upper_limb:(int)upper_limb trise:(double *)trise tset:(double *)tset;
- (int)sunRiseSetForYear:(int)year month:(int)month day:(int)day longitude:(double)lng latitude:(double)lat trise:(double *)trise tset:(double *)tset;
- (int)civilTwilightForYear:(int)year  month:(int)month day:(int)day longitude:(double)lng latitude:(double)lat trise:(double *)trise tset:(double *)tset;
- (int)nauticalTwilightForYear:(int)year  month:(int)month day:(int)day longitude:(double)lng latitude:(double)lat trise:(double *)trise tset:(double *)tset;
- (int)astronomicalTwilightForYear:(int)year  month:(int)month day:(int)day longitude:(double)lng latitude:(double)lat trise:(double *)trise tset:(double *)tset;
...
- (EDSunriseSet*)initWithTimezone:(NSTimeZone*)tz latitude:(double)lat longitude:(double)lng {
  self = [super init];
  if (self) {
    _latitude   = lat;
    _longitude  = lng;
...
+ (EDSunriseSet*)sunrisesetWithTimezone:(NSTimeZone*)tz latitude:(double)lat longitude:(double)lng {
  return [[[EDSunriseSet alloc] initWithTimezone:tz latitude:lat longitude:lng] autorelease];
}
...
- (NSDateComponents *)localTime:(NSDate *)refDate {
  ...
  return [_calendar components:( NSHourCalendarUnit  | NSMinuteCalendarUnit | NSSecondCalendarUnit) fromDate:refDate] ;
}
...
- (int)sunRiseSetForYear:(int)year month:(int)month day:(int)day longitude:(double)lng latitude:(double)lat trise:(double *)trise tset:(double *)tset {
    return [self sunRiseSetHelperForYear:year
                                   month:month
                                     day:day
                               longitude:lng
                                latitude:lat
